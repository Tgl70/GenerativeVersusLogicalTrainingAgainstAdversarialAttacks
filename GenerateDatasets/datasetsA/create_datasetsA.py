...
def create_gtsrb_data():
    ...
    np.save(f"datasets/gtsrb/X_train.npy", X_train_mod)
    np.save(f"datasets/gtsrb/y_train.npy", y_train_mod)
    np.save(f"datasets/gtsrb/X_test.npy", X_test_mod)
    np.save(f"datasets/gtsrb/y_test.npy", y_test_mod)
